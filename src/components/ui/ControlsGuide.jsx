    ...
    <>
      ...
      {open && (
        <div className="ctrl-grid">
          ...
          <img src={rotationIcon}  className="ctrl-icon" alt="" />
          <span>Rotation</span><span>Toggle background rotation</span>

          <img src={cityIcon}      className="ctrl-icon" alt="" />
          <span>Cities</span><span>Toggle city markers</span>
          ...
          <span />
          <span>Dropdown</span><span>Change color scheme</span>
